...
The original code is presented in `muon-sim.ipynb`. The submitted thesis text is available in `thesis.pdf`, 
and the associated literature survey and outline submitted in the first month of the projectis presented in `lit-review.pdf`.
